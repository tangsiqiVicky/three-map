...
export default function SpriteText( text, options ) {
...
//	options.bold = new options.cookie( 'bold' ).get( options.bold ) === 'false' ? false : true;
    ...
    sprite.update = function ( optionsUpdate ) {
        ...
        //options.font =options.bold ? "bold "+fontSize+'px'+" "+options.fontFace :''+fontSize+'px'+" "+options.fontFace;
        var fontStyle1,fontStyle2,fontStyle3;
        if(options.fontProperties){
            fontStyle1=options.fontProperties+' '
        }else{
            fontStyle1=''
        }
        if(options.bold){
        ...
        options.font=fontStyle1+fontStyle2+fontStyle3+fontSize+'px'+" "+options.fontFace
